                ...
                <div class="contact-info">
                    ...
                    <div class="contact-social">
                        ...
                        <div class="social-links">
                            <a href="https://www.facebook.com/dreamtourviaggi/?rdid=KGsap71TaKC35eZC" class="social-link" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/dream_tour_viaggi/?igsh=MW40bjZnZTZmd2I4dg%3D%3D&utm_source=qr#" class="social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://wa.me/393271294442" class="social-link" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
...
.social-link {
    ...
    box-shadow: 0 2px 8px rgba(0, 50, 132, 0.2);
}

.social-link:hover {
    background: linear-gradient(135deg, #1ba4ce 0%, #003284 100%);
    color: white;
    transform: translateY(-3px) scale(1.05);
    box-shadow: 0 6px 16px rgba(0, 50, 132, 0.4);
}
